  ...
  <div>
    ...
    <template v-else>
      ...
      <div class="col-12">
        ...
        <div class="row">
          <div v-if="workPageProductsState.noContent == true" style="margin-top: 100px; margin-inline: 209px;">
            no content
          </div>
          <div
...
import { ShowReportedProductsState } from "./ShowReportedProducts";
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const workPageProductsState = ref(new ShowReportedProductsState());
