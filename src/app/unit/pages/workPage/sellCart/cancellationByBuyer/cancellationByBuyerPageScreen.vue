...
import {cancellationByBuyerPageState} from './cancellationByBuyerPageState'
import { ScrollController } from '@/core/service/scroll.service';
import ListItem from '@/app/unit/shared/items/factorSellCartListItem/factorSellCartCancelScreen.vue'
export default {
	components:{
		ListItem
	},
	setup () {
		const state = ref(new cancellationByBuyerPageState())
