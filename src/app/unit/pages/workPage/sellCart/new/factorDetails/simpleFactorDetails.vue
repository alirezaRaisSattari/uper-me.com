  ...
  <div class="pb-5">
    ...
    <div v-if="state.factor && state.factor.factor.factorStatus !== 9">
      <div class="d-flex flex-column ">
        ...
        <div class="main-accspted-controller" v-if="(state.factor.factor.factorStatus >= 3  && state.factor.logs ) && ( state.factor.factor.factorStatus == 9)">
          <div class="accspted-controller" :class="preparationShow ? 'active':null">
            <template  v-if="!preparationShow">
              ...
              <div class="child smart-text-align" >
                ...
                <span>{{$filters.jalali(state.factor.logs[0].createdAt)}}</span>
              </div>
            </template>
            <template v-else >
