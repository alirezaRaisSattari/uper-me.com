...
import {referenceRecordsPageState} from './referenceRecordsPageState'
import { ScrollController } from '@/core/service/scroll.service';
import ListItem from '@/app/unit/shared/items/factorSellCartListItem/referenceRecordsList.vue';
...
export default {
	...
	setup () {
		const state = ref(new referenceRecordsPageState())
