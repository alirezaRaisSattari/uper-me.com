...
export class productCategoriesState {
    ...
    getListByName(name, skip) {
        ...
        ProductRepository.getInstance().SearchProducts4And5ByName(
            {
                body: {
                    skip: skip,
                    take: 20,
    ...
    GetCategoryParents(categoryId, isLevel4) {
        ...
        SettingRepository.getInstance().getListAndProductsParents(
            {
                body: {
        ...
        if (this.selectedLevel.isLevel4 === true) {
            ...
            switch (this.catConfig.step) {
                ...
                default:
                    this.catConfig.step = 5;
                    this.onCallback({postData: this.catConfig, selectedLevel: this.selectedLevel})
                    // ToastService.getInstance().success(this.selectedLevel.title)
                    break;
            }
        }
    }
